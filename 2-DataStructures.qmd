...
```{r}
gayguides[1:5, 8:9]
print(gayguides$city[1:5])
print(gayguides$Year[1:5])
#I used the print code first because it I couldn't keep it to 5 rows then I realized that putting the comma in brackets changes what is row and what is column
```
...
print(gayguides$streetaddress[2555:2560])
print(gayguides$type[2555:2560])
```
...
> It works because presidents is a vector with the list of the 3 presidents, the for p in 1:length(presidents)
...
>This line of code is just assigning grade(60) to GeorgeWashington. If you were to just type out GeorgeWashington and run that it would print out the grade.
